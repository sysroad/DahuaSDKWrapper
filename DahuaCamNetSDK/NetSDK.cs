    ...
    public static class NETClient
    {
            ...
            where T:struct
        {
            ...
            if (isGetLastError)
            {
                ...
                int error = IntPtr.Size == 4 ? OriginalSDK.CLIENT_GetLastError() : OriginalSDK.CLIENT_GetLastError_x64();
                if (0 != error)
                {
        ...
        public static bool Init(fDisConnectCallBack cbDisConnect, IntPtr dwUser, NETSDK_INIT_PARAM? stuInitParam)
        {
            ...
            try
            {
                ...
                result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_InitEx(cbDisConnect, dwUser, lpInitParam) : OriginalSDK.CLIENT_InitEx_x64(cbDisConnect, dwUser, lpInitParam);
        ...
        public static void Cleanup()
        {
            if (IntPtr.Size == 4)
                ...
                OriginalSDK.CLIENT_Cleanup_x64();
        }
        ...
        public static IntPtr Login(string pchDVRIP, ushort wDVRPort, string pchUserName, string pchPassword, EM_LOGIN_SPAC_CAP_TYPE emSpecCap, IntPtr pCapParam, ref NET_DEVICEINFO_Ex deviceInfo)
        {
            ...
            int error = 0;
            result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_LoginEx2(pchDVRIP, wDVRPort, pchUserName, pchPassword, emSpecCap, pCapParam, ref deviceInfo, ref error)
                                      : OriginalSDK.CLIENT_LoginEx2_x64(pchDVRIP, wDVRPort, pchUserName, pchPassword, emSpecCap, pCapParam, ref deviceInfo, ref error);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = false;
            result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_Logout(lLoginID)
                                      : OriginalSDK.CLIENT_Logout_x64(lLoginID);
            NetGetLastError(result);
            return result;
        }
        ...
        public static void SetAutoReconnect(fHaveReConnectCallBack cbAutoConnect, IntPtr dwUser)
        {
            if (IntPtr.Size == 4)
                ...
                OriginalSDK.CLIENT_SetAutoReconnect_x64(cbAutoConnect, dwUser);
        }
        ...
        public static void SetNetworkParam(NET_PARAM? netParam)
        {
            ...
            if (IntPtr.Size == 4)
                ...
                OriginalSDK.CLIENT_SetNetworkParam_x64(lpNetParam);
        ...
        {
            IntPtr result = IntPtr.Zero;
            result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_StartRealPlay(lLoginID, nChannelID, hWnd, rType, cbRealData, cbDisconnect, dwUser, dwWaitTime)
                                      : OriginalSDK.CLIENT_StartRealPlay_x64(lLoginID, nChannelID, hWnd, rType, cbRealData, cbDisconnect, dwUser, dwWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            IntPtr result = IntPtr.Zero;
            result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_RealPlayEx(lLoginID, nChannelID, hWnd, rType)
                                      : OriginalSDK.CLIENT_RealPlayEx_x64(lLoginID, nChannelID, hWnd, rType);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_StopRealPlayEx(lRealHandle)
                                           : OriginalSDK.CLIENT_StopRealPlayEx_x64(lRealHandle);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_SetRealDataCallBackEx2(lRealHandle, cbRealData, dwUser, (uint)dwFlag)
                                           : OriginalSDK.CLIENT_SetRealDataCallBackEx2_x64(lRealHandle, cbRealData, dwUser, (uint)dwFlag);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_SaveRealData(lRealHandle, pchFileName)
                                           : OriginalSDK.CLIENT_SaveRealData_x64(lRealHandle, pchFileName);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_StopSaveRealData(lRealHandle)
                                           : OriginalSDK.CLIENT_StopSaveRealData_x64(lRealHandle);
            NetGetLastError(result);
            return result;
        }
        ...
        public static void SetSnapRevCallBack(fSnapRevCallBack OnSnapRevMessage, IntPtr dwUser)
        {
            if (IntPtr.Size == 4)
                ...
                OriginalSDK.CLIENT_SetSnapRevCallBack_x64(OnSnapRevMessage, dwUser);
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_SnapPictureEx(lLoginID, ref par, reserved)
                                           : OriginalSDK.CLIENT_SnapPictureEx_x64(lLoginID, ref par, reserved);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_SnapPictureToFile(lLoginID, ref inParam, ref outParam, nWaitTime)
                                           : OriginalSDK.CLIENT_SnapPictureToFile_x64(lLoginID, ref inParam, ref outParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            IntPtr result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_PlayBackByTimeEx2(lLoginID, nChannelID, ref pstNetIn, ref pstNetOut)
                                             : OriginalSDK.CLIENT_PlayBackByTimeEx2_x64(lLoginID, nChannelID, ref pstNetIn, ref pstNetOut);
            NetGetLastError(result);
            return result;
        }
        ...
        public static bool QueryRecordFile(IntPtr lLoginID, int nChannelId, EM_QUERY_RECORD_TYPE nRecordFileType, DateTime tmStart, DateTime tmEnd, string pchCardid, ref NET_RECORDFILE_INFO[] nriFileinfo, ref int filecount, int waittime, bool bTime)
        {
            ...
            try
            {
                ...
                {
                    returnValue = IntPtr.Size == 4 ? OriginalSDK.CLIENT_QueryRecordFile(lLoginID, nChannelId, (int)nRecordFileType, ref timeStart, ref timeEnd, pchCardid, pBoxInfo, maxlen, ref filecount, waittime, bTime)
                                                   : OriginalSDK.CLIENT_QueryRecordFile_x64(lLoginID, nChannelId, (int)nRecordFileType, ref timeStart, ref timeEnd, pchCardid, pBoxInfo, maxlen, ref filecount, waittime, bTime);
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_GetPlayBackOsdTime(lPlayHandle, ref lpOsdTime, ref lpStartTime, ref lpEndTime)
                                           : OriginalSDK.CLIENT_GetPlayBackOsdTime_x64(lPlayHandle, ref lpOsdTime, ref lpStartTime, ref lpEndTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_CapturePictureEx(hPlayHandle, pchPicFileName, eFormat)
                                           : OriginalSDK.CLIENT_CapturePictureEx_x64(hPlayHandle, pchPicFileName, eFormat);
            NetGetLastError(result);
            return result;
        }
                                                     ...
                                                     fDataCallBack fDownLoadDataCallBack, IntPtr dwDataUser, IntPtr pReserved)
        {
            ...
            result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_DownloadByTimeEx(lLoginID, nChannelId, (int)nRecordFileType, ref startTime, ref endTime, sSavedFileName,
                                                     cbTimeDownLoadPos, dwUserData, fDownLoadDataCallBack, dwDataUser, pReserved)
                                      : OriginalSDK.CLIENT_DownloadByTimeEx_x64(lLoginID, nChannelId, (int)nRecordFileType, ref startTime, ref endTime, sSavedFileName,
                                                     cbTimeDownLoadPos, dwUserData, fDownLoadDataCallBack, dwDataUser, pReserved);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_StopDownload(lFileHandle)
                                           : OriginalSDK.CLIENT_StopDownload_x64(lFileHandle);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_GetDownloadPos(lFileHandle, ref nTotalSize, ref nDownLoadSize)
                                           : OriginalSDK.CLIENT_GetDownloadPos_x64(lFileHandle, ref nTotalSize, ref nDownLoadSize);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_DHPTZControlEx2(lLoginID, nChannelID, (uint)dwPTZCommand, lParam1, lParam2, lParam3, dwStop, param4)
                                           : OriginalSDK.CLIENT_DHPTZControlEx2_x64(lLoginID, nChannelID, (uint)dwPTZCommand, lParam1, lParam2, lParam3, dwStop, param4);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_OpenSound(lPlayHandle)
                                           : OriginalSDK.CLIENT_OpenSound_x64(lPlayHandle);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_CloseSound()
                                           : OriginalSDK.CLIENT_CloseSound_x64();
            NetGetLastError(result);
            return result;
        }
        #endregion
        ...
        public static bool PlayBackControl(IntPtr lPlayHandle, PlayBackType type)
        {
            ...
            switch (type)
            {
                case PlayBackType.Play:
                    result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_PausePlayBack(lPlayHandle, false)
                                              : OriginalSDK.CLIENT_PausePlayBack_x64(lPlayHandle, false);
                    NetGetLastError(result);
                    break;
                case PlayBackType.Pause:
                    result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_PausePlayBack(lPlayHandle, true)
                                              : OriginalSDK.CLIENT_PausePlayBack_x64(lPlayHandle, true);
                    NetGetLastError(result);
                    break;
                case PlayBackType.Stop:
                    result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_StopPlayBack(lPlayHandle)
                                              : OriginalSDK.CLIENT_StopPlayBack_x64(lPlayHandle);
                    NetGetLastError(result);
                    break;
                case PlayBackType.Fast:
                    result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_FastPlayBack(lPlayHandle)
                                              : OriginalSDK.CLIENT_FastPlayBack_x64(lPlayHandle);
                    NetGetLastError(result);
                    break;
                case PlayBackType.Slow:
                    result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_SlowPlayBack(lPlayHandle)
                                              : OriginalSDK.CLIENT_SlowPlayBack_x64(lPlayHandle);
                    NetGetLastError(result);
                    break;
                case PlayBackType.Normal:
                    result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_NormalPlayBack(lPlayHandle)
                                              : OriginalSDK.CLIENT_NormalPlayBack_x64(lPlayHandle);
                    NetGetLastError(result);
                    break;
                default:
                    break;
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_SetDeviceMode(lLoginID, emType, pValue)
                                           : OriginalSDK.CLIENT_SetDeviceMode_x64(lLoginID, emType, pValue);
            NetGetLastError(result);
            return result;
        }
        ...
        public static void SetDVRMessCallBack(fMessCallBackEx cbMessage, IntPtr dwUser)
        {
            if (IntPtr.Size == 4)
                ...
                OriginalSDK.CLIENT_SetDVRMessCallBackEx1_x64(cbMessage, dwUser);
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_StartListenEx(lLoginID)
                                           : OriginalSDK.CLIENT_StartListenEx_x64(lLoginID);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_StopListen(lLoginID)
                                           : OriginalSDK.CLIENT_StopListen_x64(lLoginID);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            IntPtr result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_RealLoadPictureEx(lLoginID, nChannelID, dwAlarmType, bNeedPicFile, cbAnalyzerData, dwUser, reserved)
                                             : OriginalSDK.CLIENT_RealLoadPictureEx_x64(lLoginID, nChannelID, dwAlarmType, bNeedPicFile, cbAnalyzerData, dwUser, reserved);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_StopLoadPic(lAnalyzerHandle)
                                           : OriginalSDK.CLIENT_StopLoadPic_x64(lAnalyzerHandle);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_QuerySystemInfo(lLoginID, (int)nSystemType, pSysInfoBuffer, maxlen, ref nSysInfolen, waittime)
                                           : OriginalSDK.CLIENT_QuerySystemInfo_x64(lLoginID, (int)nSystemType, pSysInfoBuffer, maxlen, ref nSysInfolen, waittime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_QueryDeviceLog(lLoginID, ref pQueryParam, pLogBuffer, nLogBufferLen, ref pRecLogNum, waittime)
                                           : OriginalSDK.CLIENT_QueryDeviceLog_x64(lLoginID, ref pQueryParam, pLogBuffer, nLogBufferLen, ref pRecLogNum, waittime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            IntPtr result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_StartTalkEx(lLoginID, pfcb, dwUser)
                                             : OriginalSDK.CLIENT_StartTalkEx_x64(lLoginID, pfcb, dwUser);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_StopTalkEx(lTalkHandle)
                                           : OriginalSDK.CLIENT_StopTalkEx_x64(lTalkHandle);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_RecordStartEx(lLoginID)
                                           : OriginalSDK.CLIENT_RecordStartEx_x64(lLoginID);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_RecordStopEx(lLoginID)
                                           : OriginalSDK.CLIENT_RecordStopEx_x64(lLoginID);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            int result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_TalkSendData(lTalkHandle, pSendBuf, dwBufSize)
                                          : OriginalSDK.CLIENT_TalkSendData_x64(lTalkHandle, pSendBuf, dwBufSize);
            NetGetLastError(result);
            return result;
        }
        ...
        public static void AudioDec(IntPtr pAudioDataBuf, uint dwBufSize)
        {
            if (IntPtr.Size == 4)
                ...
                OriginalSDK.CLIENT_AudioDec_x64(pAudioDataBuf, dwBufSize);
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_ControlDevice(lLoginID, type, param, waittime)
        ...
        public static bool QueryDevState(IntPtr lLoginID, int nType, ref object obj, Type typeName, int waittime)
        {
            ...
            try
            {
                ...
                Marshal.StructureToPtr(obj, pBuf, true);
                result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_QueryDevState(lLoginID, nType, pBuf, nBufLen, ref pRetLen, waittime)
                                          : OriginalSDK.CLIENT_QueryDevState_x64(lLoginID, nType, pBuf, nBufLen, ref pRetLen, waittime);
                NetGetLastError(result);
        ...
        public static bool QueryDevState(IntPtr lLoginID, EM_DEVICE_STATE nType, ref object obj, Type typeName, int waittime)
        {
            ...
            try
            {
                ...
                pBuf = Marshal.AllocHGlobal(Marshal.SizeOf(typeName));
                Marshal.StructureToPtr(obj, pBuf, true);
                result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_QueryDevState(lLoginID, (int)nType, pBuf, nBufLen, ref pRetLen, waittime)
                                          : OriginalSDK.CLIENT_QueryDevState_x64(lLoginID, (int)nType, pBuf, nBufLen, ref pRetLen, waittime);
                NetGetLastError(result);
                obj = Marshal.PtrToStructure(pBuf, typeName);
            }
            finally
        ...
        public static bool QueryNewSystemInfo(IntPtr lLoginID, Int32 lChannel, string strCommand, ref object obj, Type typeName, int waittime)
        {
            ...
            try
            {
                ...
                {
                    returnValue = IntPtr.Size == 4 ? OriginalSDK.CLIENT_QueryNewSystemInfo(lLoginID, strCommand, lChannel, pInBuf, nBufSize, ref nError, waittime)
                                                   : OriginalSDK.CLIENT_QueryNewSystemInfo_x64(lLoginID, strCommand, lChannel, pInBuf, nBufSize, ref nError, waittime);
                    NetGetLastError(returnValue);
                    if (returnValue == true)
                    {
                        returnValue = IntPtr.Size == 4 ? OriginalSDK.CLIENT_ParseData(strCommand, pInBuf, pOutBuf, (UInt32)Marshal.SizeOf(typeName), pRetLen)
                                                       : OriginalSDK.CLIENT_ParseData_x64(strCommand, pInBuf, pOutBuf, (UInt32)Marshal.SizeOf(typeName), pRetLen);
        ...
        public static bool FindRecord(IntPtr lLoginID, EM_NET_RECORD_TYPE emRecordType, object oCondition, Type tyCondition, ref IntPtr lFindID, int waittime)
        {
            ...
            try
            {
                ...
                result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_FindRecord(lLoginID, ref stuInParam, ref stuOutParam, waittime)
                                          : OriginalSDK.CLIENT_FindRecord_x64(lLoginID, ref stuInParam, ref stuOutParam, waittime);
                NetGetLastError(result);
        ...
        public static int FindNextRecord(IntPtr lFindeHandle, int nMaxNum, ref int nRetNum , ref List<object> ls, Type tyRecord, int waittime)
        {
            ...
            try
            {
                ...
                result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_FindNextRecord(ref stuInParam, ref stuOutParam, waittime)
                                          : OriginalSDK.CLIENT_FindNextRecord_x64(ref stuInParam, ref stuOutParam, waittime);
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_FindRecordClose(lFindHandle)
                                           : OriginalSDK.CLIENT_FindRecordClose_x64(lFindHandle);
            NetGetLastError(result);
            return result;
        }
        ...
        public static bool QueryRecordCount(IntPtr lFindHandle, ref int nRecordCount, int waittime)
        {
            ...
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_QueryRecordCount(ref stuInParam, ref stuOutParam, waittime)
                                           : OriginalSDK.CLIENT_QueryRecordCount_x64(ref stuInParam, ref stuOutParam, waittime);
        ...
        {
            IntPtr pRet = IntPtr.Size == 4 ? OriginalSDK.CLIENT_StartFindNumberStat(lLoginID, ref pstInParam, ref pstOutParam)
                                           : OriginalSDK.CLIENT_StartFindNumberStat_x64(lLoginID, ref pstInParam, ref pstOutParam);
        ...
        public static int DoFindNumberStat(IntPtr lFindHandle, ref NET_IN_DOFINDNUMBERSTAT pstInParam, ref NET_NUMBERSTAT[] pNumberStats)
        {
            ...
            try
            {
                ...
                nRet = IntPtr.Size == 4 ? OriginalSDK.CLIENT_DoFindNumberStat(lFindHandle, ref pstInParam, ref stuOutParam)
                                        : OriginalSDK.CLIENT_DoFindNumberStat_x64(lFindHandle, ref pstInParam, ref stuOutParam);
        ...
        {
            bool bRet = IntPtr.Size == 4 ? OriginalSDK.CLIENT_StopFindNumberStat(lFindHandle)
                                         : OriginalSDK.CLIENT_StopFindNumberStat_x64(lFindHandle);
        ...
        {
            IntPtr pRet = IntPtr.Size == 4 ? OriginalSDK.CLIENT_AttachVideoStatSummary(lLoginID, ref pInParam, ref pOutParam, nWaitTime)
                                           : OriginalSDK.CLIENT_AttachVideoStatSummary_x64(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(pRet);
            return pRet;
        }
        ...
        {
            bool bRet = IntPtr.Size == 4 ? OriginalSDK.CLIENT_DetachVideoStatSummary(lAttachHandle)
                                         : OriginalSDK.CLIENT_DetachVideoStatSummary_x64(lAttachHandle);
            NetGetLastError(bRet);
            return bRet;
        }
        #endregion
        ...
        {
            IntPtr result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_CreateTransComChannel(lLoginID, TransComType, baudrate, databits, stopbits, parity, cbTransCom, dwUser)
                                             : OriginalSDK.CLIENT_CreateTransComChannel_x64(lLoginID, TransComType, baudrate, databits, stopbits, parity, cbTransCom, dwUser);
            NetGetLastError(result);
            return result;
        }
        ...
        public static bool SendTransComData(IntPtr lTransComChannel, byte[] byDatas)
        {
            ...
            try
            {
                ...
                result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_SendTransComData(lTransComChannel, pBuffer, (uint)byDatas.Length)
                                          : OriginalSDK.CLIENT_SendTransComData(lTransComChannel, pBuffer, (uint)byDatas.Length);
            }
            finally
            {
                Marshal.FreeHGlobal(pBuffer);
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_DestroyTransComChannel(lTransComChannel)
                                           : OriginalSDK.CLIENT_DestroyTransComChannel_x64(lTransComChannel);
            NetGetLastError(result);
            return result;
        }
        #endregion <<Trans Com>>
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_SetSecurityKey(lPlayHandle, szKey, (uint)szKey.Length)
                                           : OriginalSDK.CLIENT_SetSecurityKey_x64(lPlayHandle, szKey, (uint)szKey.Length);
            NetGetLastError(result);
            return result;
        } 
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_QueryMatrixCardInfo(lLoginID, ref pstuCardList, nWaitTime)
                                           : OriginalSDK.CLIENT_QueryMatrixCardInfo_x64(lLoginID, ref pstuCardList, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_GetSplitCaps(lLoginId, nChannel, ref stuCaps, nWaitTime)
                                           : OriginalSDK.CLIENT_GetSplitCaps_x64(lLoginId, nChannel, ref stuCaps, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_SetSplitMode(lLoginID, nChannel, ref stuSplitInfo, nWaitTime)
                                           : OriginalSDK.CLIENT_SetSplitMode_x64(lLoginID, nChannel, ref stuSplitInfo, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_OpenSplitWindow(lLoginID, ref pInParam, ref pOutParam, nWaitTime)
                                           : OriginalSDK.CLIENT_OpenSplitWindow_x64(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        public static bool MatrixGetCameras(IntPtr lLoginID, out NET_MATRIX_CAMERA_INFO[] stuCameras, int nMaxCameraCount, int nWaitTime)
        {
            ...
            try
            {
                ...
                result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_MatrixGetCameras(lLoginID, ref stuInParam, ref stuOutParam, nWaitTime)
                                          : OriginalSDK.CLIENT_MatrixGetCameras_x64(lLoginID, ref stuInParam, ref stuOutParam, nWaitTime);
                NetGetLastError(result);
                if (result)
                {
        ...
        public static bool SetSplitSource(IntPtr lLoginID, int nChannel, int nWindow, NET_SPLIT_SOURCE[] stuSplitSrcs, int nWaitTime)
        {
            ...
            try
            {
                ...
                result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_SetSplitSource(lLoginID, nChannel, nWindow, pstuSplitSrc, stuSplitSrcs.Length, nWaitTime)
                                          : OriginalSDK.CLIENT_SetSplitSource_x64(lLoginID, nChannel, nWindow, pstuSplitSrc, stuSplitSrcs.Length, nWaitTime);
            }
            finally
            {
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_SetSplitSourceEx(lLoginID, ref inParam, ref outParam, nWaitTime)
                                           : OriginalSDK.CLIENT_SetSplitSourceEx_x64(lLoginID, ref inParam, ref outParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        #endregion
        ...
        public static bool GetNewDevConfig(IntPtr lLoginID, Int32 lChannel, string strCommand, ref object obj, Type typeName, int waittime)
        {
            ...
            try
            {
                ...
                if (pInBuf != IntPtr.Zero && pOutBuf != IntPtr.Zero)
                {
                    returnValue = IntPtr.Size == 4 ? OriginalSDK.CLIENT_GetNewDevConfig(lLoginID, strCommand, lChannel, pInBuf, nBufSize, out nError, waittime)
                                                   : OriginalSDK.CLIENT_GetNewDevConfig_x64(lLoginID, strCommand, lChannel, pInBuf, nBufSize, out nError, waittime);

                    if (returnValue == true)
                    {
                        returnValue = IntPtr.Size == 4 ? OriginalSDK.CLIENT_ParseData(strCommand, pInBuf, pOutBuf, (UInt32)Marshal.SizeOf(typeName), IntPtr.Zero)
                                                       : OriginalSDK.CLIENT_ParseData_x64(strCommand, pInBuf, pOutBuf, (UInt32)Marshal.SizeOf(typeName), IntPtr.Zero);
        ...
        public static bool GetNewDevConfig(IntPtr lLoginID, Int32 lChannel, string strCommand, ref object[] objs, Type typeName, int waittime)
        {
            ...
            try
            {
                ...
                if (pInBuf != IntPtr.Zero && pOutBuf != IntPtr.Zero)
                {
                    returnValue = IntPtr.Size == 4 ? OriginalSDK.CLIENT_GetNewDevConfig(lLoginID, strCommand, lChannel, pInBuf, nInBufSize, out nError, waittime)
                                                   : OriginalSDK.CLIENT_GetNewDevConfig_x64(lLoginID, strCommand, lChannel, pInBuf, nInBufSize, out nError, waittime);

                    if (returnValue == true)
                    {
                        returnValue = IntPtr.Size == 4 ? OriginalSDK.CLIENT_ParseData(strCommand, pInBuf, pOutBuf, (uint)nOutBufSize, pRetBytes)
                                                       : OriginalSDK.CLIENT_ParseData_x64(strCommand, pInBuf, pOutBuf, (uint)nOutBufSize, pRetBytes);
                        if (returnValue)
                        {
        ...
        public static bool SetNewDevConfig(IntPtr lLoginID, int lChannel, string strCommand, object obj, Type typeName, int waittime)
        {
            ...
            try
            {
                ...
                returnValue = IntPtr.Size == 4 ? OriginalSDK.CLIENT_PacketData(strCommand, pInBuf, (UInt32)Marshal.SizeOf(typeName), pOutBuf, nBufSize)
                                               : OriginalSDK.CLIENT_PacketData_x64(strCommand, pInBuf, (UInt32)Marshal.SizeOf(typeName), pOutBuf, nBufSize);

                if (returnValue)
                {
                    returnValue = IntPtr.Size == 4 ? OriginalSDK.CLIENT_SetNewDevConfig(lLoginID, strCommand, lChannel, pOutBuf, nBufSize, ref nError, ref nRestart, waittime)
                                                   : OriginalSDK.CLIENT_SetNewDevConfig_x64(lLoginID, strCommand, lChannel, pOutBuf, nBufSize, ref nError, ref nRestart, waittime);
                }
            }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_PacketData(szCommand, lpInBuffer, dwInBufferSize, szOutBuffer, dwOutFufferSize)
                                           : OriginalSDK.CLIENT_PacketData_x64(szCommand, lpInBuffer, dwInBufferSize, szOutBuffer, dwOutFufferSize);
            NetGetLastError(result);
            return result;
        }
        ...
        public static bool SetNewDevConfigs(IntPtr lLoginID, int lChannel, string strCommand, object[] objs, Type typeName, int waittime)
        {
            ...
            try
            {
                ...
                returnValue = IntPtr.Size == 4 ? OriginalSDK.CLIENT_PacketData(strCommand, pInBuf, (UInt32)(Marshal.SizeOf(typeName) * objs.Length), pOutBuf, nBufSize)
                                               : OriginalSDK.CLIENT_PacketData_x64(strCommand, pInBuf, (UInt32)(Marshal.SizeOf(typeName) * objs.Length), pOutBuf, nBufSize);
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_QueryDeviceTime(lLoginID, ref pDeviceTime, waittime)
                                           : OriginalSDK.CLIENT_QueryDeviceTime_x64(lLoginID, ref pDeviceTime, waittime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_SetupDeviceTime(lLoginID, ref DeviceTime)
                                           : OriginalSDK.CLIENT_SetupDeviceTime_x64(lLoginID, ref DeviceTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_ClearRepeatEnter(lLoginID, ref pInParam, ref pOutParam, nWaitTime)
                                           : OriginalSDK.CLIENT_ClearRepeatEnter_x64(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_FaceInfoOpreate(lLoginID, emType, pInParam, pOutParam, nWaitTime)
                                           : OriginalSDK.CLIENT_FaceInfoOpreate_x64(lLoginID, emType, pInParam, pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            IntPtr result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_StartFindFaceInfo(lLoginID, ref inParam, ref outParam, nWaitTime)
                                             : OriginalSDK.CLIENT_StartFindFaceInfo_x64(lLoginID, ref inParam, ref outParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_DoFindFaceInfo(lFindHandle, ref inParam, ref outParam, nWaitTime)
                                           : OriginalSDK.CLIENT_DoFindFaceInfo_x64(lFindHandle, ref inParam, ref outParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_StopFindFaceInfo(lFindHandle)
                                           : OriginalSDK.CLIENT_StopFindFaceInfo_x64(lFindHandle);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_OperateFaceRecognitionDB(lLoginID, ref pstInParam, ref pstOutParam, nWaitTime)
                                           : OriginalSDK.CLIENT_OperateFaceRecognitionDB_x64(lLoginID, ref pstInParam, ref pstOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        public static IntPtr FindFile(IntPtr lLoginID, EM_FILE_QUERY_TYPE emType, object oQueryCondition, Type tyCondition, int waittime)
        {
            ...
            try
            {
                ...
                result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_FindFileEx(lLoginID, emType, pCondition, IntPtr.Zero, waittime)
                                          : OriginalSDK.CLIENT_FindFileEx_x64(lLoginID, emType, pCondition, IntPtr.Zero, waittime);
                NetGetLastError(result);
            }
            finally
            {
        ...
        public static int FindNextFile(IntPtr lFindHandle, int nFilecount, List<object> lsOMediaFileInfo, Type tyFile , int waittime)
        {
            ...
            try
            {
                ...
                result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_FindNextFileEx(lFindHandle, nFilecount, pMediaFileInfo, maxBufLen, IntPtr.Zero, waittime)
                                          : OriginalSDK.CLIENT_FindNextFileEx_x64(lFindHandle, nFilecount, pMediaFileInfo, maxBufLen, IntPtr.Zero, waittime);
                if (result >= 0)
                {
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_FindCloseEx(lFindHandle)
                                           : OriginalSDK.CLIENT_FindCloseEx_x64(lFindHandle);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_DetectFace(lLoginID, ref pstInParam, ref pstOutParam, nWaitTime)
                                           : OriginalSDK.CLIENT_DetectFace_x64(lLoginID, ref pstInParam, ref pstOutParam, nWaitTime);
        ...
        {
            IntPtr nHanddle = IntPtr.Size == 4 ? OriginalSDK.CLIENT_AttachFaceFindState(lLoginID, ref pstInParam, ref pstOutParam, nWaitTime)
                                               : OriginalSDK.CLIENT_AttachFaceFindState_x64(lLoginID, ref pstInParam, ref pstOutParam, nWaitTime);
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_DetachFaceFindState(lAttachHandle)
                                           : OriginalSDK.CLIENT_DetachFaceFindState_x64(lAttachHandle);
            NetGetLastError(result);
            return result;
        }
        ...
        public static bool StartFindFaceRecognition(IntPtr lLoginID, ref NET_IN_STARTFIND_FACERECONGNITION pstInParam, ref NET_OUT_STARTFIND_FACERECONGNITION pstOutParam, int waittime)
        {
            ...
            try
            {
                ...
                result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_StartFindFaceRecognition(lLoginID, inPtr, outPtr, waittime)
                                          : OriginalSDK.CLIENT_StartFindFaceRecognition_x64(lLoginID, inPtr, outPtr, waittime);
                NetGetLastError(result);
                if (result)
                {
            ...
            int waittime)
        {
            ...
            try
            {
                ...
                Marshal.StructureToPtr(pstOutParam, outPtr, true);
                result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_DoFindFaceRecognition(inPtr, outPtr, waittime)
                                          : OriginalSDK.CLIENT_DoFindFaceRecognition_x64(inPtr, outPtr, waittime);
                NetGetLastError(result);
                if (result)
                {
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_StopFindFaceRecognition(lFindHandle)
                                           : OriginalSDK.CLIENT_StopFindFaceRecognition_x64(lFindHandle);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_DoFindFaceRecognitionRecordEx(ref inParam, ref outParam, nWaitTime)
                                           : OriginalSDK.CLIENT_DoFindFaceRecognitionRecordEx_x64(ref inParam, ref outParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        public static bool FaceRecognitionPutDisposition(IntPtr lLoginID, NET_IN_FACE_RECOGNITION_PUT_DISPOSITION_INFO inParam, ref NET_OUT_FACE_RECOGNITION_PUT_DISPOSITION_INFO outParam, int nWaitTime)
        {
            ...
            try
            {
                ...
                result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_FaceRecognitionPutDisposition(lLoginID, inPtr, outPtr, nWaitTime)
                                          : OriginalSDK.CLIENT_FaceRecognitionPutDisposition_x64(lLoginID, inPtr, outPtr, nWaitTime);
                NetGetLastError(result);
                if (result)
                {
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_FaceRecognitionDelDisposition(lLoginID, ref inParam, ref outParam, nWaitTime)
                                           : OriginalSDK.CLIENT_FaceRecognitionDelDisposition_x64(lLoginID, ref inParam, ref outParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool bReturn = IntPtr.Size == 4 ? OriginalSDK.CLIENT_GetTotalFileCount(lFindHandle, ref pTotalCount, pReserved, nWaittime)
                                            : OriginalSDK.CLIENT_GetTotalFileCount_x64(lFindHandle, ref pTotalCount, pReserved, nWaittime);
        ...
        {
            bool bReturn = IntPtr.Size == 4 ? OriginalSDK.CLIENT_SetFindingJumpOption(lFindHandle, ref pOption, reserved, waittime)
                                            : OriginalSDK.CLIENT_SetFindingJumpOption_x64(lFindHandle, ref pOption, reserved, waittime);
            NetGetLastError(bReturn);
            return bReturn;
        }
        ...
        {
            bool bReturn = IntPtr.Size == 4 ? OriginalSDK.CLIENT_FindGroupInfo(lLoginID, ref pstInParam, ref pstOutParam, nWaitTime)
                                            : OriginalSDK.CLIENT_FindGroupInfo_x64(lLoginID, ref pstInParam, ref pstOutParam, nWaitTime);
            NetGetLastError(bReturn);
            return bReturn;
        }
        ...
        {
            bool bReturn = IntPtr.Size == 4 ? OriginalSDK.CLIENT_OperateFaceRecognitionGroup(lLoginID, ref pstInParam, ref pstOutParam, nWaitTime)
                                            : OriginalSDK.CLIENT_OperateFaceRecognitionGroup_x64(lLoginID, ref pstInParam, ref pstOutParam, nWaitTime);
            NetGetLastError(bReturn);
            return bReturn;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_RenderPrivateData(lPlayHandle, bTrue)
                                           : OriginalSDK.CLIENT_RenderPrivateData_x64(lPlayHandle, bTrue);
            NetGetLastError(result);
            return result;
        }
        #endregion
        ...
        public static bool QueryDevInfo(IntPtr lLoginID,  ref NET_IN_STORAGE_DEV_INFOS stuInInfo, ref NET_OUT_STORAGE_DEV_INFOS stuOutInfo, int nWaitTime)
        {
            ...
            try
            {
                ...
                bool bRet = IntPtr.Size == 4 ? OriginalSDK.CLIENT_QueryDevInfo(lLoginID, 0x02, pInBuf, pOutBuf, IntPtr.Zero, nWaitTime)
                                             : OriginalSDK.CLIENT_QueryDevInfo_x64(lLoginID, 0x02, pInBuf, pOutBuf, IntPtr.Zero, nWaitTime);
                if (bRet)
                {
        ...
        public static bool GetOSDConfig(IntPtr lLoginID, EM_CFG_OSD_TYPE emCfgOpType, int nChannelID, ref object obj,int waittime)
        {
            ...
            try
            {
                ...
                result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_GetConfig(lLoginID, (int)emCfgOpType, nChannelID, outPtr, (uint)Marshal.SizeOf(type), waittime, IntPtr.Zero)
                                          : OriginalSDK.CLIENT_GetConfig_x64(lLoginID, (int)emCfgOpType, nChannelID, outPtr, (uint)Marshal.SizeOf(type), waittime, IntPtr.Zero);
                NetGetLastError(result);
        ...
        public static bool SetOSDConfig(IntPtr lLoginID, EM_CFG_OSD_TYPE emCfgOpType, int nChannelID, object obj, int waittime)
        {
            ...
            try
            {
                ...
                result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_SetConfig(lLoginID, (int)emCfgOpType, nChannelID, inPtr, (uint)Marshal.SizeOf(type), waittime, IntPtr.Zero, IntPtr.Zero)
                                          : OriginalSDK.CLIENT_SetConfig_x64(lLoginID, (int)emCfgOpType, nChannelID, inPtr, (uint)Marshal.SizeOf(type), waittime, IntPtr.Zero, IntPtr.Zero);
                NetGetLastError(result);
            }
            finally
            {
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_GetSplitWindowsInfo(lLoginID, ref pInParam, ref pOutParam, nWaitTime)
                                           : OriginalSDK.CLIENT_GetSplitWindowsInfo_x64(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        public static bool OperateSplit(IntPtr lLoginID, EM_NET_SPLIT_OPERATE_TYPE emType, object inParam, ref object outParam, int nWaitTime)
        {
            ...
            try
            {
                ...
                Marshal.StructureToPtr(outParam, outPtr, true);
                result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_OperateSplit(lLoginID, emType, inPtr, outPtr, nWaitTime)
                                          : OriginalSDK.CLIENT_OperateSplit_x64(lLoginID, emType, inPtr, outPtr, nWaitTime);
                NetGetLastError(result);
                if(result)
                {
        ...
        public static bool OperateSplitPlayer(IntPtr lLoginID, EM_NET_PLAYER_OPERATE_TYPE emType, object inParam, ref object outParam, int nWaitTime)
        {
            ...
            try
            {
                ...
                outPtr = Marshal.AllocHGlobal(Marshal.SizeOf(outParam.GetType()));
                Marshal.StructureToPtr(outParam, outPtr, true);
                result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_OperateSplitPlayer(lLoginID, emType, inPtr, outPtr, nWaitTime)
                                          : OriginalSDK.CLIENT_OperateSplitPlayer_x64(lLoginID, emType, inPtr, outPtr, nWaitTime);
                NetGetLastError(result);
                if (result)
                {
                    outParam = Marshal.PtrToStructure(outPtr, outParam.GetType());
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_WindowRegionEnlarge(lLoginID, ref inParam, ref outParam, nWaitTime)
                                           : OriginalSDK.CLIENT_WindowRegionEnlarge_x64(lLoginID, ref inParam, ref outParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_WindowEnlargeReduction(lLoginID, ref inParam, ref outParam, nWaitTime)
                                           : OriginalSDK.CLIENT_WindowEnlargeReduction_x64(lLoginID, ref inParam, ref outParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_OperateTrafficList(lLoginID, ref inParam, ref outParam, waittime)
                                           : OriginalSDK.CLIENT_OperateTrafficList_x64(lLoginID, ref inParam, ref outParam, waittime);
            NetGetLastError(result);
            return result;
        }
        ...
        public static IntPtr FileTransmit(IntPtr lLoginID, EM_FIELTRANSMIT_TYPE nTransType, object obj, fTransFileCallBack cbTransFile, IntPtr dwUserData, int waittime)
        {
            ...
            try
            {
                ...
                result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_FileTransmit(lLoginID, (int)nTransType, bufPtr, Marshal.SizeOf(obj.GetType()), cbTransFile, dwUserData, waittime)
                                          : OriginalSDK.CLIENT_FileTransmit_x64(lLoginID, (int)nTransType, bufPtr, Marshal.SizeOf(obj.GetType()), cbTransFile, dwUserData, waittime);
                NetGetLastError(result);
            }
            finally
            {
		...
		public static bool QueryUserInfoNew(IntPtr lLoginID, ref NET_USER_MANAGE_INFO_NEW info, int waittime)
        {
            ...
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_QueryUserInfoNew(lLoginID, inPtr, IntPtr.Zero, waittime)
                                      : OriginalSDK.CLIENT_QueryUserInfoNew_x64(lLoginID, inPtr, IntPtr.Zero, waittime);
            NetGetLastError(result);
            if (result)
            {
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_OperateUserInfoNew(lLoginID, (int)nOperateType, opParam, subParam, IntPtr.Zero, waittime)
                                           : OriginalSDK.CLIENT_OperateUserInfoNew_x64(lLoginID, (int)nOperateType, opParam, subParam, IntPtr.Zero, waittime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            IntPtr result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_StartSearchDevices(cbSearchDevice, pUserData, szLocalIp)
                                             : OriginalSDK.CLIENT_StartSearchDevices_x64(cbSearchDevice, pUserData, szLocalIp);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            int error = 0;
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_ModifyDevice(ref devNetInfo, dwWaitTime, ref error, null, IntPtr.Zero)
                                           : OriginalSDK.CLIENT_ModifyDevice_x64(ref devNetInfo, dwWaitTime, ref error, null, IntPtr.Zero);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_StopSearchDevices(lSearchHandle)
                                           : OriginalSDK.CLIENT_StopSearchDevices_x64(lSearchHandle);
            NetGetLastError(result);
            return result;
        }
		...
		public static bool DownloadRemoteFile(IntPtr lLoginID, NET_IN_DOWNLOAD_REMOTE_FILE inParam, int nWaitTime)
        {
            ...
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_DownloadRemoteFile(lLoginID, ref inParam, ref outParam, nWaitTime)
                                           : OriginalSDK.CLIENT_DownloadRemoteFile_x64(lLoginID, ref inParam, ref outParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_SetDeviceSearchParam(ref inParam)
                                           : OriginalSDK.CLIENT_SetDeviceSearchParam_x64(ref inParam);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_GetDevConfig(lLoginID, (uint)type, lChannel, lpOutBuffer, dwOutBufferSize, ref bytesReturned, waittime)
                                           : OriginalSDK.CLIENT_GetDevConfig_x64(lLoginID, (uint)type, lChannel, lpOutBuffer, dwOutBufferSize, ref bytesReturned, waittime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_SetDevConfig(lLoginID, (uint)type, lChannel, lpInBuffer, dwInBufferSize, waittime)
                                           : OriginalSDK.CLIENT_SetDevConfig_x64(lLoginID, (uint)type, lChannel, lpInBuffer, dwInBufferSize, waittime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            IntPtr result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_DownloadByRecordFile(lLoginID, ref lpRecordFile, sSavedFileName, cbDownLoadPos, dwUserData)
                                             : OriginalSDK.CLIENT_DownloadByRecordFile_x64(lLoginID, ref lpRecordFile, sSavedFileName, cbDownLoadPos, dwUserData);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_RebootDev(lLoginID)
                                           : OriginalSDK.CLIENT_RebootDev_x64(lLoginID);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_Attendance_AddUser(lLoginID, ref stuInAddUser, ref stuOutAddUser, nWaitTime)
                                           : OriginalSDK.CLIENT_Attendance_AddUser_x64(lLoginID, ref stuInAddUser, ref stuOutAddUser, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_Attendance_DelUser(lLoginID, ref stuInDelUser, ref stuOutDelUser, nWaitTime)
                                           : OriginalSDK.CLIENT_Attendance_DelUser_x64(lLoginID, ref stuInDelUser, ref stuOutDelUser, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_Attendance_ModifyUser(lLoginID, ref stuInModifyUser, ref stuOutModifyUser, nWaitTime)
                                           : OriginalSDK.CLIENT_Attendance_ModifyUser_x64(lLoginID, ref stuInModifyUser, ref stuOutModifyUser, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_Attendance_GetUser(lLoginID, ref stuInGetUser, ref stuOutGetUser, nWaitTime)
                                           : OriginalSDK.CLIENT_Attendance_GetUser_x64(lLoginID, ref stuInGetUser, ref stuOutGetUser, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_Attendance_FindUser(lLoginID, ref stuInFindUser, ref stuOutFindUser, nWaitTime)
                                           : OriginalSDK.CLIENT_Attendance_FindUser_x64(lLoginID, ref stuInFindUser, ref stuOutFindUser, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_Attendance_InsertFingerByUserID(lLoginID, ref stuInInsert, ref stuOutInsert, nWaitTime)
                                           : OriginalSDK.CLIENT_Attendance_InsertFingerByUserID_x64(lLoginID, ref stuInInsert, ref stuOutInsert, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_Attendance_RemoveFingerByUserID(lLoginID, ref stuInRemove, ref stuOutRemove, nWaitTime)
                                           : OriginalSDK.CLIENT_Attendance_RemoveFingerByUserID_x64(lLoginID, ref stuInRemove, ref stuOutRemove, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_Attendance_GetFingerByUserID(lLoginID, ref stuIn, ref stuOut, nWaitTime)
                                           : OriginalSDK.CLIENT_Attendance_GetFingerByUserID_x64(lLoginID, ref stuIn, ref stuOut, nWaitTime);
            NetGetLastError(result);
            return result;
        }
		...
		public static IntPtr AttachMotionData(IntPtr lLoginID, NET_IN_ATTACH_MOTION_DATA inParam, int nWaitTime)
        {
            ...
            IntPtr result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_AttachMotionData(lLoginID, ref inParam, ref outParam, nWaitTime)
                                             : OriginalSDK.CLIENT_AttachMotionData_x64(lLoginID, ref inParam, ref outParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_DetachMotionData(lAttachHandle)
                                           : OriginalSDK.CLIENT_DetachMotionData_x64(lAttachHandle);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_SearchDevicesByIPs(ref pIpSearchInfo, cbSearchDevices, dwUserData, szLocalIp, dwWaitTime)
                                           : OriginalSDK.CLIENT_SearchDevicesByIPs_x64(ref pIpSearchInfo, cbSearchDevices, dwUserData, szLocalIp, dwWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_InitDevAccount(ref pInitAccountIn, ref pInitAccountOut, dwWaitTime, szLocalIp)
                                           : OriginalSDK.CLIENT_InitDevAccount_x64(ref pInitAccountIn, ref pInitAccountOut, dwWaitTime, szLocalIp);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_GetDevCaps(lLoginID, (int)nType, pInBuf, pOutBuf, nWaitTime)
                                           : OriginalSDK.CLIENT_GetDevCaps_x64(lLoginID, (int)nType, pInBuf, pOutBuf, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            IntPtr result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_ListenServer(ip, port, nTimeout, cbListen, dwUserData)
                                             : OriginalSDK.CLIENT_ListenServer_x64(ip, port, nTimeout, cbListen, dwUserData);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_StopListenServer(lServerHandle)
                                           : OriginalSDK.CLIENT_StopListenServer_x64(lServerHandle);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_QueryProductionDefinition(lLoginID, ref pstuProdDef, nWaitTime)
                                           : OriginalSDK.CLIENT_QueryProductionDefinition_x64(lLoginID, ref pstuProdDef, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_QueryDevInfo(lLoginID, (int)emQueryType, pInBuf, pOutBuf, IntPtr.Zero, nWaitTime)
                                           : OriginalSDK.CLIENT_QueryDevInfo_x64(lLoginID, (int)emQueryType, pInBuf, pOutBuf, IntPtr.Zero, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        public static IntPtr AttachCameraState(IntPtr lLoginID, NET_IN_CAMERASTATE pstInParam, ref NET_OUT_CAMERASTATE pstOutParam, int nWaitTime = 3000)
        {
            ...
            lAttachHandle = IntPtr.Size == 4 ? OriginalSDK.CLIENT_AttachCameraState(lLoginID, ref pstInParam, ref pstOutParam, nWaitTime)
                                             : OriginalSDK.CLIENT_AttachCameraState_x64(lLoginID, ref pstInParam, ref pstOutParam, nWaitTime);
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_DetachCameraState(lAttachHandle)
                                           : OriginalSDK.CLIENT_DetachCameraState_x64(lAttachHandle);
            NetGetLastError(result);
            return result; 
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_GetSoftwareVersion(lLoginID, ref pstInParam, ref pstOutParam, nWaitTime)
                                           : OriginalSDK.CLIENT_GetSoftwareVersion_x64(lLoginID, ref pstInParam, ref pstOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_GetDeviceType(lLoginID, ref pstInParam, ref pstOutParam, nWaitTime)
                                           : OriginalSDK.CLIENT_GetDeviceType_x64(lLoginID, ref pstInParam, ref pstOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_LogOpen(ref pstLogPrintInfo)
                                           : OriginalSDK.CLIENT_LogOpen_x64(ref pstLogPrintInfo);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_AudioDecEx(lTalkHandle, pAudioDataBuf, dwBufSize)
                                           : OriginalSDK.CLIENT_AudioDecEx_x64(lTalkHandle, pAudioDataBuf, dwBufSize);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_Attendance_GetFingerRecord(lLoginID, ref pstuInGet, ref pstuOutGet, nWaitTime)
                                           : OriginalSDK.CLIENT_Attendance_GetFingerRecord_x64(lLoginID, ref pstuInGet, ref pstuOutGet, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_Attendance_RemoveFingerRecord(lLoginID, ref pstuInRemove, ref pstuOutRemove, nWaitTime)
                                           : OriginalSDK.CLIENT_Attendance_RemoveFingerRecord_x64(lLoginID, ref pstuInRemove, ref pstuOutRemove, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_OperateAccessFingerprintService(lLoginID, emtype, pstInParam, pstOutParam, nWaitTime)
                                           : OriginalSDK.CLIENT_OperateAccessFingerprintService_x64(lLoginID, emtype, pstInParam, pstOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            IntPtr result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_SCADAAlarmAttachInfo(lLoginID, ref pInParam, ref pOutParam, nWaitTime)
                                             : OriginalSDK.CLIENT_SCADAAlarmAttachInfo_x64(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_SCADAAlarmDetachInfo(lAttachHandle)
                                           : OriginalSDK.CLIENT_SCADAAlarmDetachInfo_x64(lAttachHandle);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            IntPtr result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_SCADAAttachInfo(lLoginID, ref pInParam, ref pOutParam, nWaitTime)
                                             : OriginalSDK.CLIENT_SCADAAttachInfo_x64(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_SCADADetachInfo(lAttachHandle)
                                           : OriginalSDK.CLIENT_SCADADetachInfo_x64(lAttachHandle);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_StartFind(lLoginID, emType, pInBuf, pOutBuf, nWaitTime)
                                           : OriginalSDK.CLIENT_StartFind_x64(lLoginID, emType, pInBuf, pOutBuf, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_DoFind(lLoginID, emType, pInBuf, pOutBuf, nWaitTime)
                                           : OriginalSDK.CLIENT_DoFind_x64(lLoginID, emType, pInBuf, pOutBuf, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_StopFind(lLoginID, emType, pInBuf, pOutBuf, nWaitTime)
                                           : OriginalSDK.CLIENT_StopFind_x64(lLoginID, emType, pInBuf, pOutBuf, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            IntPtr result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_RadiometryAttach(lLoginID, ref pInParam, ref pOutParam, nWaitTime)
                                             : OriginalSDK.CLIENT_RadiometryAttach_x64(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_RadiometryDetach(lAttachHandle)
                                           : OriginalSDK.CLIENT_RadiometryDetach_x64(lAttachHandle);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = IntPtr.Size == 4 ? OriginalSDK.CLIENT_RadiometryFetch(lLoginID, ref pInParam, ref pOutParam, nWaitTime)
                                           : OriginalSDK.CLIENT_RadiometryFetch_x64(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
